...
Personal hub / mega-dashboard for my Unraid homelab. Next.js app, read-only, LAN/Tailscale-only (no login — never expose it publicly), deployed as a Docker container on the Unraid box itself.
...
- [plan/01-plex-auth.md](plan/01-plex-auth.md) — Plex PIN auth design (parked, not being built)
